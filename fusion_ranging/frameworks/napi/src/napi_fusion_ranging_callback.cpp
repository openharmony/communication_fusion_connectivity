...
NapiFusionRangingCallback::NapiFusionRangingCallback()
    : eventSubscribe_({STR_FUSION_RANGING_CALLBACK_STATE_CHANGE,
        STR_FUSION_RANGING_CALLBACK_RESULT}, "default")
{}

void NapiFusionRangingCallback::OnRangingStateChanged(const RangingStateChangeInfo &stateInfo)
{
...
void NapiFusionRangingCallback::OnRangingResult(const RangingResult &result)
{
    auto nativeObject = std::make_shared<NapiNativeRangingResult>(result);
    eventSubScribe_.PublishEvent(STR_FUSION_RANGING_CALLBACK_RESULT, nativeObject);
}
